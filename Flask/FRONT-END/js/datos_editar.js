...
// Crear un objeto para almacenar los destinos de las variables y sus valores
let resultado = {};

// Iterar sobre los parámetros y guardar los destinos y valores en el objeto resultado
for (const [destino, valor] of datos) {
    resultado[destino] = valor;
    resultado[origen] = valor;
    resultado[costo] = valor;
...
document.getElementById("destino").value = resultado["destino"]
document.getElementById("origen").value = resultado["origen"]
document.getElementById("costo").value = resultado["costo"]
document.getElementById("dias").value = resultado["dias"]
